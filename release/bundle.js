...
/**
 * Created by liliz on 2017/12/15.
 */
// Parameters
var onPage = module.exports.onPage = "/";
var params = module.exports.params = {};
 ...
 * Created by liliz on 2017/12/15.
 */
// Require routing parameter
var router = __webpack_require__(14);

// Actions
var switchPage = module.exports.switchPage = function (page, params) {
    if (params) router.params = params;else router.params = {};
    router.onPage = page;
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__render__ = __webpack_require__(30);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__render__["a" /* default */], null);
  }
});
...
// Require routing parameter
var routingParams = __webpack_require__(14);

// Require page renderer
var HomePageRenderer = __webpack_require__(31);
var AddPageRenderer = __webpack_require__(34);
var DetailPageRenderer = __webpack_require__(35);

var routing = {
    "/": homePageRenderer,
    "/add": addPageRenderer,
    "/detail": detailPageRenderer

    // module.exports = function() {
    //     document.body.textContent = "";
    //     document.body.appendChild(routing[routingParams.onPage]().dom);
    // }
};document.body.textContent = "";
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(HomePageRenderer, null);
    }
});
...
// Require todo parameters
var todoList = __webpack_require__(32).todoList;
// Require todo action
var removeTodo = __webpack_require__(33).removeTodo;
// Require routing action
var switchPage = __webpack_require__(15).switchPage;

function TODOItemList(props) {
    const todos = props.todos;
    const todoItems = todos.map(todo => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "li",
        null,
        todo.name
    ));
...
/* harmony default export */ __webpack_exports__["default"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            null,
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(TODOItemList, { todos: todoList })
        );
    }
});
...
var todolist = module.exports.todoList = [{ name: "breakfase", description: "Having breakfast" }, { name: "run", description: "Running for an hour" }, { name: "lunch", description: "Having lunch" }];
var idCounting = module.exports.idCounting = 0;
...
//var addTodo = require("../actions/todoAction").addTodo;
var switchPage = __webpack_require__(15).switchPage;
...
/* harmony default export */ __webpack_exports__["default"] = (class extends Component {
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            null,
